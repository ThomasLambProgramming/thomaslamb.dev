...
const ProjectModal: React.FC<ModalProps> = (properties) => {
  ...
  const modal = (
    <div className={`${properties.darkMode ? "dark" : ""} block overflow-y-scroll`}>
      <div className='fixed overscroll-none inset-0 flex items-center overflow-y-hidden z-20 w-full h-full align-middle justify-center' onClick={properties.hide} />
      ...
      <div className={`fixed ${properties.darkMode ? "bg-DarkNeutral-300/95" : "bg-Neutral-200/95"} hideScroll max-w-[1200px] inset-0 overflow-y-scroll z-30 rounded-lg align-middle w-[95%] h-full m-auto text-center`}>
