...
const ProjectModal: React.FC<ModalProps> = (properties) => {
    ...
    const modal = (
        <div className={`${properties.darkMode ? "dark" : ""} block overflow-y-scroll`}>
                ...
                <div className={`fixed ${properties.darkMode ? "bg-DarkNeutral-300/95" : "bg-Neutral-200/90"} hideScroll max-w-[1500px] inset-0 overflow-y-scroll z-30 rounded-lg align-middle w-[95%] h-full m-auto text-center`}>
                    <div className="text-gray-950 w-full max-w-[1200px] flex align-middle justify-center flex-col items-center m-auto opacity-[100%] pb-12 dark:text-Neutral-600 text-DarkNeutral-0">
                        {componentToRender}
                    </div>
