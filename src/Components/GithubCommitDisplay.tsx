...
const GithubCommitDisplay: React.FC<{isDarkMode: boolean}> = ({isDarkMode}) =>
{
    ...
    <div className="mr-6 mt-8 lg:justify-normal lg:align-top align-middle items-center">
        ...
        <div className={"lg:-rotate-90 lg:min-w-[660px] mr-5 p-2 rounded-sm" + (isDarkMode ? " bg-DarkNeutral-400" : "bg-Neutral-100")}>
            <img src={isDarkMode ? "http://ghchart.rshah.org/000000/ThomasLambProgramming" : "http://ghchart.rshah.org/000000/ThomasLambProgramming"} alt="ThomasLamb GithubChart"/>
        </div>
    </div>
    );
}
