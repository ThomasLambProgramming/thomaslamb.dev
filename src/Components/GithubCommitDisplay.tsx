...
const GithubCommitDisplay: React.FC<{ isDarkMode: boolean }> = ({ isDarkMode }) => {
  return (
    <div className="lg:mt-8 mt-2 lg:justify-normal lg:align-top align-middle items-center z-10">
      {/* Possibly change the commit history text to be the github logo */}
      <h3 className="align-center dark:text-DarkNeutral-300 lg:align-middle justify-center mr-5 text-md lg:pb-[20px] ml-2 lg:text-start text-center ">Commit History</h3>
      {/* Image must always be larger than 660px as that is the raw size and if it gets scaled down it is unreadable */}

      <div className={"lg:-rotate-90 lg:min-w-[660px] lg:mb-[100px] lg:min-h-[650px] lg:ml-0 ml-8 lg:mr-5 rounded-sm"}>
