...
const AboutSection: React.FC<{ isDarkMode: boolean }> = ({ isDarkMode }) => {
  return (
    <div className={"pb-6 " + (isDarkMode ? "shadow-gray-700 shadow-md " : "")}>
      ...
      <p className='ml-8'>
        Hello, my name is Thomas Lamb. I have been working professionally as a game programmer since 2022, with additional experience studying Unity at AIE during 2020-2021. I am eager to learn any form of game programming, with a current interest in graphics and gameplay.
      </p>
