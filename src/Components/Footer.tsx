function Footer() {
  return (
    <div>
      <footer className="bg-zinc-100 rounded-3xl shadow m-6 dark:bg-gray-800 ">
        <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
          ...
          <ul className="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
            ...
            <li>
              ...
              <a href="https://twitter.com/ShaderRaccoon">
                <svg
            ...
            <li>
              ...
              <a href="https://www.linkedin.com/in/thomaslambprogramming/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5"
                  fill="currentColor"
